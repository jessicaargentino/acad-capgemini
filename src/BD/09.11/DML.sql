...
values('Laura', 'Palmer', 17);

insert into pessoa(nome, sobrenome, idade)
values('Laura', 'Palmer', 17);

into pessoa(nome, sobrenome, idade)
values('Dale', 'Cooper', 34);

insert into pessoa(nome, sobrenome, idade)
values('The', 'Arm', 0);

insert into endereco(logradouro, numero, complemento, bairro, cidade, cep)
values('Rua Bolinho', 1, 'Casa', 'Bernice', 'Twin Peaks', '40982-880');

-- UPDATE

update pessoa
set nome = 'Audrey', sobrenome = 'Horne', idade = 18
where id = 1;
